...
export const Navbar = () => {
  ...
  const handleSubmit =()=>{
    ...
    if(id){
      axios.put('https://dainamic-portfolio-backend-git-main-md-shahadat-alams-projects.vercel.app/navbar/'+id,data).then(res=>{
       console.log(res)
       setMenu('')
       setButtonText('')
       setShowButton('')
    ...
    axios.post('https://dainamic-portfolio-backend-git-main-md-shahadat-alams-projects.vercel.app/navbar',data).then(res=>{
     console.log(res)
  ...
  <div className="p-6 bg-white rounded-lg shadow-lg w-full max-w-lg mx-auto">
     ...
     <img  src={`https://dainamic-portfolio-backend-git-main-md-shahadat-alams-projects.vercel.app/${logoImg}`} alt="logo Image" />
  <div className="mb-2">
